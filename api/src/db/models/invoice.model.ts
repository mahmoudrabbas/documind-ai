...
const schema = new Schema<InvoiceDocument>({
  ...
  paymentReference: { type: String, default: "", select: false },
...
schema.index({ tenantId: 1, refundedAmountMinor: 1, reservedRefundAmountMinor: 1 }, { name: "idx_invoice_tenant_refund_amounts" });

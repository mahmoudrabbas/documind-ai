...
export const GUIDE_FLOWS: readonly GuideFlow[] = [
  ...
  {
    flowId: "documents.download",
    titleKey: "copilot.guide.documents.download.title",
    requiredPermissions: [Permission.DOCUMENTS_READ],
    entryRoute: "/dashboard/documents",
    steps: [
      step(
  ...
  {
    flowId: "documents.editMetadata",
    titleKey: "copilot.guide.documents.editMetadata.title",
    requiredPermissions: [Permission.DOCUMENTS_UPDATE],
    entryRoute: "/dashboard/documents",
    steps: [
      step(
  ...
  {
    flowId: "users.list",
    titleKey: "copilot.guide.users.list.title",
  ...
  {
    flowId: "settings.updateTenant",
    titleKey: "copilot.guide.settings.updateTenant.title",
    requiredPermissions: [Permission.COMPANY_SETTINGS_UPDATE],
    entryRoute: "/dashboard/settings",
    steps: [
      step(

...
vi.mock("../../../../../config/index.js", () => ({ config: { STRIPE_SECRET_KEY: "sk_test_not_real", STRIPE_WEBHOOK_SECRET: "whsec_test_not_real", BILLING_PORTAL_ALLOWED_ORIGIN: "https://example.com", NODE_ENV: "test" } }));
...
function createMockStripe() {
  ...
  const mock = {
    ...
    charges: { retrieve: vi.fn(async () => ({ id: "ch_shared", customer: "cus_shared", currency: "usd", amount: 1000, amount_refunded: 0 })) },
    refunds: {

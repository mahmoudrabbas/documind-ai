...
const definitions: readonly PermissionDefinitionSource[] = [
  ...
  { id: Permission.NOTIFICATIONS_UPDATE, group: "notifications", label: "Manage Notifications", description: "Update notification lifecycle state", defaultBaseRoles: ["COMPANY_ADMIN"], delegableByTenantAdmin: true, platformOnly: false, deprecated: false, compatibleScopes: NO_SCOPES },

...
import { idSchema, packageBodySchema, packageUpdateSchema, parse, settingsBodySchema, subscriptionUpdateSchema, } from "./platform.validator.js";
...
test("platform settings accept primitives and reject nested secrets", () => {
    assert.deepEqual(parse(settingsBodySchema, { maintenanceMode: true, trialDays: 14 }), {
        maintenanceMode: true,
        trialDays: 14,
    });
    assert.throws(() => parse(settingsBodySchema, { provider: { apiKey: "secret" } }), AppError);
});
//# sourceMappingURL=platform.validator.test.js.map
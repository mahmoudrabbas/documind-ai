      ...
      <div className="space-y-6">
        ...
        <DashboardPanel>
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <Link href="/dashboard/settings/document-taxonomy" data-guide-id="settings-taxonomy-link" className="rounded bg-primary px-4 py-2 text-sm font-medium text-white">Open document taxonomy</Link>
          </div>
        </DashboardPanel>

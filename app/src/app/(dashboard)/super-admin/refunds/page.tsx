            ...
            <tr key={refund.id}>
              ...
              <td className="cell">
                <div className="flex flex-wrap gap-2">
                  ...
                  {canConfirm && refund.status === "REQUESTED" ? <button type="button" onClick={() => setConfirmRefund(refund)} className="cursor-pointer rounded-lg bg-[#0369A1] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#0284C7] active:scale-95 transition-all duration-150">{t("refundAdmin.confirm")}</button> : null}

...
vi.mock("@/services/billing.service", () => ({ getBillingSummary: vi.fn(), listInvoices: vi.fn(), createBillingPortalSession: vi.fn(), getInvoiceLinks: vi.fn() }));
...
const summary = {
  ...
  providerManaged: true, providerLinked: true, pendingOperation: null, canOpenPortal: true, canUpdatePaymentMethod: true, canViewInvoices: true, canChangePlan: false, canCancel: false, canReactivate: false, canRequestRefund: false,

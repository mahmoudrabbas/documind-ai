...
describe("guide-targets registry", () => {
  ...
  it("mirrors the backend registry ids (guideTargets.ts)", () => {
    const expected = [
      ...
      "documents-drawer-delete",
      "documents-delete-confirm",
      "documents-drawer-edit",
      "documents-drawer-edit-title",
      "documents-drawer-edit-description",
      "documents-drawer-edit-tags",
      "documents-drawer-edit-save",
      "documents-drawer-replace",
      "documents-drawer-replace-file",
      "documents-drawer-replace-submit",
      "taxonomy-create-button",
      "users-invite-button",
      "users-invite-form-department",

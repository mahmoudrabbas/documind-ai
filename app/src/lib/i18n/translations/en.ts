...
const en: TranslationDictionary = {
  ...
  "documents.editDetails": "Edit details",
  ...
  "copilot.tabs.guides": "Guides",
  "copilot.tabs.actions": "Actions",
  "copilot.action.cancel": "Cancel",
  "copilot.action.input.placeholder": "Type your answer…",
  "copilot.action.input.progress": "{{remaining}} questions remaining",
  "copilot.action.input.field.user.invite.name": "What is the new user's full name?",
  "copilot.action.input.field.user.invite.email": "What is the new user's email address?",
  "copilot.action.input.field.user.invite.role": "Which role should the new user have?",
  "copilot.action.input.field.roles.create.name": "What should the role be called?",
  "copilot.action.input.field.roles.create.baseRole": "Which base role should the new role build on?",
  "copilot.action.input.field.roles.create.grants": "What should this role be able to do? Describe the permissions in plain language, e.g. \"view users\", \"upload and edit documents\", \"view analytics\".",
  "copilot.action.input.field.user.target": "Which user? Please type the user's email address or name.",
  "copilot.action.input.field.document.target": "Which document? Please type the document name.",
  "copilot.action.input.field.document.updateMetadata.changes": "What should I change? For example: \"title: New title\" or \"category: HR\".",
  "copilot.action.input.field.settings.update.settings": "What setting would you like to change? For example: \"company name\", \"language to Arabic\", or \"turn off citations\".",
  ...
  "copilot.action.plan.confirm.noPlan": "No action plan is currently pending.",
  "copilot.action.plan.confirm.missingApproval": "Could not find a pending approval for this action. The approval may have expired.",
  "copilot.action.plan.confirm.expired": "This approval has expired. Please trigger the action again to create a new request.",
  "copilot.action.plan.confirmDoubleCheck": "This action is destructive and cannot be undone. Click confirm again to proceed.",
  "copilot.action.plan.confirm.timeout": "The request timed out. Please try again.",
  "copilot.action.plan.cancel": "Cancel",
  ...
  "copilot.actions.title": "Actions",
  "copilot.actions.subtitle": "Let the assistant handle it for you",
  "copilot.action.chip.document.search": "Search documents",
  "copilot.action.chip.document.get": "View a document",
  "copilot.action.chip.user.invite": "Invite a team member",
  "copilot.action.chip.user.list": "List users",
  "copilot.action.chip.user.resendInvitation": "Resend invitation",
  "copilot.action.chip.document.archive": "Archive a document",
  "copilot.action.chip.document.restore": "Restore a document",
  "copilot.action.chip.document.updateMetadata": "Update document details",
  "copilot.action.chip.settings.update": "Update company settings",
  "copilot.action.chip.roles.create": "Create a role",
  "copilot.action.chip.user.revokeInvitation": "Revoke invitation",
  "copilot.action.chip.document.softDelete": "Move to trash",
  "copilot.action.chip.user.delete": "Delete a user",
  "copilot.action.chip.document.permanentDelete": "Permanently delete a document",
};

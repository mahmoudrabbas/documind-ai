...
const ar: TranslationDictionary = {
  ...
  "documents.noMatchingDocuments": "لا توجد مستندات تطابق عوامل التصفية",
  "documents.noMatchingDocumentsHint": "جرّب بحثًا مختلفًا أو امسح عوامل التصفية.",
  "documents.clearFilters": "مسح عوامل التصفية",
  ...
  "documents.editDetails": "تعديل التفاصيل",
  ...
  "copilot.tabs.guides": "الأدلة",
  "copilot.tabs.actions": "الإجراءات",
  "copilot.action.cancel": "إلغاء",
  "copilot.action.input.placeholder": "اكتب إجابتك…",
  "copilot.action.input.progress": "{{remaining}} أسئلة متبقية",
  "copilot.action.input.field.user.invite.name": "ما الاسم الكامل للمستخدم الجديد؟",
  "copilot.action.input.field.user.invite.email": "ما البريد الإلكتروني للمستخدم الجديد؟",
  "copilot.action.input.field.user.invite.role": "ما الدور الذي يجب أن يتمتع به المستخدم الجديد؟",
  "copilot.action.input.field.roles.create.name": "ماذا يجب أن يُسمى الدور؟",
  "copilot.action.input.field.roles.create.baseRole": "على أي دور أساسي يُبنى الدور الجديد؟",
  "copilot.action.input.field.roles.create.grants": "ما الذي يجب أن يكون هذا الدور قادراً على فعله؟ صف الصلاحيات بلغة بسيطة، مثلاً \"عرض المستخدمين\" أو \"رفع وتعديل المستندات\" أو \"عرض التحليلات\".",
  "copilot.action.input.field.user.target": "من المستخدم؟ اكتب البريد الإلكتروني أو اسم المستخدم.",
  "copilot.action.input.field.document.target": "أي مستند؟ اكتب اسم المستند.",
  "copilot.action.input.field.document.updateMetadata.changes": "ما الذي تريد تغييره؟ مثال: \"العنوان: عنوان جديد\" أو \"التصنيف: الموارد البشرية\".",
  "copilot.action.input.field.settings.update.settings": "ما الإعداد الذي تريد تغييره؟ مثال: \"اسم الشركة\"، \"اللغة إلى العربية\"، أو \"إيقاف الاستشهادات\".",
  ...
  "copilot.action.plan.confirm.noPlan": "لا يوجد خطة إجراء معلقة حالياً.",
  "copilot.action.plan.confirm.missingApproval": "لم يتم العثور على موافقة معلقة لهذا الإجراء. قد تكون الصلاحية قد انتهت.",
  "copilot.action.plan.confirm.expired": "انتهت صلاحية هذه الموافقة. يرجى إعادة تنفيذ الإجراء لإنشاء طلب جديد.",
  "copilot.action.plan.confirmDoubleCheck": "هذا الإجراء تدميري ولا يمكن التراجع عنه. انقر على التأكيد مرة أخرى للمتابعة.",
  "copilot.action.plan.confirm.timeout": "انتهت مهلة الطلب. يرجى المحاولة مرة أخرى.",
  "copilot.action.plan.cancel": "إلغاء",
  ...
  "copilot.actions.title": "الإجراءات",
  "copilot.actions.subtitle": "دع المساعد ينفذها نيابة عنك",
  "copilot.action.chip.document.search": "البحث في المستندات",
  "copilot.action.chip.document.get": "عرض مستند",
  "copilot.action.chip.user.invite": "دعوة عضو فريق",
  "copilot.action.chip.user.list": "قائمة المستخدمين",
  "copilot.action.chip.user.resendInvitation": "إعادة إرسال الدعوة",
  "copilot.action.chip.document.archive": "أرشفة مستند",
  "copilot.action.chip.document.restore": "استعادة مستند",
  "copilot.action.chip.document.updateMetadata": "تعديل بيانات المستند",
  "copilot.action.chip.settings.update": "تحديث إعدادات الشركة",
  "copilot.action.chip.roles.create": "إنشاء دور",
  "copilot.action.chip.user.revokeInvitation": "إلغاء الدعوة",
  "copilot.action.chip.document.softDelete": "نقل إلى سلة المهملات",
  "copilot.action.chip.user.delete": "حذف مستخدم",
  "copilot.action.chip.document.permanentDelete": "حذف مستند نهائيًا",
};
